...
if exist 3dco.res del 3dco.res

windres -O coff 3dco.rc -o 3dco.res

REM Run g++ with explicit file expansion
g++ -std=c++17 -g -mwindows -Wall src\glad.c src\imgui\*.cpp src\*.cpp -I include -I src\imgui -o 3dco.exe 3dco.res -L lib -lSDL2 -lglfw3 -lmingw32 -lgdi32 -lopengl32
